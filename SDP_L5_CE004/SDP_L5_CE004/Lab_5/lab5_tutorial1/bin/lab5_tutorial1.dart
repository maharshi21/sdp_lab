...
void main(List<String> arguments) {
  ...
  */
  ...
  const desserts = [
    ...
    'Riya',
    'Shruti'
  ]; //This is same as , final desserts = const['maharshi','smit','dhruv'];
  // Below 3 will not work because list is const
  // desserts.add('kashyap');
  // desserts.remove('maharshi');
  // desserts[0] = 'abc';
  ...
  */
  ...
  /*
  // List properties
  const drinks = ['water', 'milk', 'juice', 'protein shake'];
  ...
  */
  ...
  // Challenge 3:
  User user1 = User(1, 'Maharshi');
  User user2 = User(2, 'Dhruv');
  User user3 = User(3, 'Smit');
